...
- [AT89LP IDE](#at89lp-ide)
  ...
  - [Overview](#overview-1)
  - [Free VS Premium](#free-vs-premium-1)
  - [Quick Start Guide](#quick-start-guide-1)
    - [1. Install the dependencies](#1-install-the-dependencies-1)
    - [2. Install AT89LP IDE](#2-install-at89lp-ide-1)
    - [3. Create a project](#3-create-a-project-1)
  - [Why AT89LP IDE?](#why-at89lp-ide-1)
  - [Requirements](#requirements-1)
  - [Interface](#interface-1)
    - [Build Menu](#build-menu-1)
    - [Program Menu](#program-menu-1)
    - [Serial Monitor](#serial-monitor-1)
  - [License](#license-1)
...
[GitHub](https://github.com/JodusMelodus) • [YouTube](https://www.youtube.com/@JodusMelodus) • [Visual Studio Marketplace](https://marketplace.visualstudio.com/publishers/jodusmelodus-dev)
...
Debug your serial communications directly inside VS Code using the built-in serial monitor. Choose your serial port and baud rate with ease. Send and receive serial data using the integrated serial monitor.
